...
import type { GetBrandApiResponseType } from "@/schemas/brand/brandSchema";
...
const dummyBrands: Brand[] = [
  ...
  },
  {
    id: "3",
    name: "Puma",
    logo: "https://upload.wikimedia.org/wikipedia/commons/7/75/Puma_Logo.svg",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center space-x-3">
              <button className="p-2 text-gray-500 hover:text-gray-700 rounded-xl hover:bg-gray-100 transition-colors"></button>
              <button
