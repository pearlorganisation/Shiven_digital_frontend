        ...
        <div className="flex justify-between items-center h-14 lg:h-16">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="hidden md:flex nav-element bg-blue-600 px-5 py-2 text-xs font-bold text-white hover:bg-blue-950 transition-all rounded-full hover:scale-105 cursor-pointer"
            >
            ...
            <button
              onClick={() => navigate("/auth/login")}   
              className="nav-element hidden md:block px-6 lg:px-8 py-2.5 bg-gradient-to-r from-[#FF8C42] to-[#FFB347] text-white font-black text-[11px] rounded-full shadow-lg shadow-orange-100 hover:scale-105 cursor-pointer hover:shadow-orange-300 hover:-translate-y-1 transition-all uppercase tracking-widest"
            >
