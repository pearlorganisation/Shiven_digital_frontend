...
// //       // Fix: Pre-set hardware acceleration to prevent first-scroll flicker
// //       gsap.set(slides, { force3D: true, transformPerspective: 1000, backfaceVisibility: "hidden" });
...
// //   return (
// //     <div ref={sectionRef} className="bg-[#FFFEFA] w-full min-h-screen">
// //       <div className="relative h-screen flex flex-col pt-12 overflow-hidden">
        
// //         {/* HEADER */}
// //         <div className="relative z-[100] w-full text-center px-6 mb-8 bg-[#FFFEFA]/95 pb-2">
// //           <h2 className="text-3xl lg:text-5xl font-black text-[#1E1E1E] leading-tight tracking-tight">
// //             Features & Content Creation tools
// //           </h2>
// //           <div className="mt-3 flex items-center justify-center gap-4">
// //             <div className="h-px w-10 bg-[#1F6ED4]/20" />
// //             <p className="text-[10px] lg:text-xs text-[#6C757D] font-bold uppercase tracking-[0.4em]">
// //               Seamless • Data-Driven • Creative
// //             </p>
// //             <div className="h-px w-10 bg-[#1F6ED4]/20" />
...
// //         {/* SLIDES STACK */}
// //         <div className="relative w-full max-w-7xl mx-auto flex-grow h-[60vh]">
// //           {SLIDES.map((slide, index) => (
// //             <div 
// //               key={slide.id}
// //               className={`stack-slide absolute inset-0 w-full h-full will-change-transform ${index === 0 ? 'opacity-100' : 'opacity-0'}`}
// //               style={{ zIndex: 10 + index }}
// //             >
// //               <div className="grid lg:grid-cols-12 h-full items-start gap-8 px-6 lg:px-12">
                
// //                 {/* 1/4 Image Side */}
// //                 <div className="lg:col-span-3 h-full hidden lg:block">
// //                   <div className="h-[48vh] w-full rounded-[2rem] overflow-hidden border border-gray-100 shadow-sm">
// //                     <img src={slide.img} className="w-full h-full object-cover" alt="dashboard preview" />
// //                   </div>
// //                 </div>

// //                 {/* 3/4 Content Side */}
// //                 <div className="lg:col-span-9 flex flex-col justify-start pt-1">
// //                   <div className="grid lg:grid-cols-2 gap-x-10 gap-y-6 lg:gap-y-8">
// //                     {slide.items.map((item) => (
// //                       <div key={item.id} className="space-y-1">
// //                         <div className="flex items-start gap-3">
// //                           <CheckCircle2 size={16} className="text-[#1F6ED4] shrink-0 mt-1" />
// //                           <h3 className="text-sm lg:text-[15px] font-black uppercase tracking-tight text-[#1E1E1E] leading-tight">
// //                             {item.title}
// //                           </h3>
// //                         </div>
// //                         <p className="text-[11px] lg:text-[12px] leading-relaxed text-[#6C757D] font-medium pl-7">
// //                           {item.text}
// //                         </p>
// //                       </div>
// //                     ))}
...
// //         {/* Footer info */}
// //         <div className="absolute bottom-8 left-0 w-full z-[110] px-10 text-center">
// //             <p className="text-[9px] font-black text-[#1F6ED4]/40 uppercase tracking-[0.2em] italic">
// //                Every feature in chicku.in is designed to scale precisely.
// //             </p>
// //         </div>
...
//       // 1. Hard-set initial states via GSAP to prevent React/CSS hydration flickering
//       gsap.set(slides, { 
//         transformOrigin: "center top",
//         force3D: true, 
//       });

//       // Hide all slides EXCEPT the first one by pushing them down initially
...
//           trigger: sectionRef.current,
//           start: "top top",
//           end: `+=${slides.length * 100}%`, // Adjusted for pacing
//           pin: true,
//           scrub: 1, 
//           anticipatePin: 1,
//         }
...
//         // Animate previous slide: scale down and fade out
//         tl.to(slides[i - 1], { 
//           scale: 0.92, 
//           opacity: 0, 
//           duration: 1,
//           ease: "none" 
//         }, i)
//         // Animate incoming slide: slide up smoothly over the previous one
//         .to(slide, { 
//           yPercent: 0, 
//           duration: 1, 
//           ease: "none",
//           boxShadow: "0px -20px 40px rgba(0,0,0,0.04)" // Adds depth to separate layers visually
//         }, i); 
//       });
//     }, sectionRef);
...
//   return (
//     <div ref={sectionRef} className="bg-[#FFFEFA] w-full min-h-screen">
//       <div className="relative h-screen flex flex-col pt-24 overflow-hidden">
        
//         {/* HEADER */}
//         <div className="relative z-[100] w-full text-center px-6 mb-8 bg-[#FFFEFA]/95 pb-2">
//           <h2 className="text-2xl lg:text-5xl font-black text-[#1E1E1E] leading-tight tracking-tight">
//             Features & Content Creation tools
//           </h2>
//           <div className="mt-3 hidden md:flex items-center justify-center gap-4">
//             <div className="h-px w-10 bg-[#1F6ED4]/20" />
//             <p className="text-[10px] lg:text-xs text-[#6C757D] font-bold uppercase tracking-[0.4em]">
//               Seamless • Data-Driven • Creative
//             </p>
...
//             <div 
//               key={slide.id}
//               // FIX: Added bg-[#FFFEFA], removed will-change-transform and removed conditional opacity
//               className="stack-slide absolute inset-0 w-full h-full "
//               style={{ zIndex: 10 + index }}
//             >
//               <div className="grid lg:grid-cols-12 h-full items-start gap-8 px-6 lg:px-12">
...
//                 {/* 1/4 Image Side */}
//                 <div className="lg:col-span-3 h-full hidden lg:block">
//                   <div className="h-[48vh] w-full rounded-[2rem] overflow-hidden border ">
//                     <img src={slide.img} className="w-full h-full object-cover" alt="dashboard preview" />
//                   </div>
//                 </div>
...
const FeatureStack: React.FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    mm.add("(min-width: 1024px)", () => {
      ...
      gsap.set(slides, { force3D: true, autoAlpha: 0, yPercent: 100 });
    ...
    mm.add("(max-width: 1023px)", () => {
      // --- MOBILE: CLEANUP ---
      // Ensure slides are visible and naturally flowed
      gsap.set(slides, { autoAlpha: 1, yPercent: 0, clearProps: "all" });
    });
  ...
  return (
    <div className="bg-[#FFFEFA] w-full relative">
      {/* 
         On Desktop: triggerRef is the pin wrapper (h-screen).
         On Mobile: It's just a normal container (min-h-screen).
      */}
      <div 
        ref={triggerRef} 
        className="relative w-full h-auto lg:h-screen flex flex-col pt-12 lg:pt-24 lg:overflow-hidden"
      >
        
        {/* HEADER */}
        <div className="relative z-[100] w-full text-center px-6 mb-8 lg:mb-8 bg-[#FFFEFA] pb-2 shrink-0">
          <h2 className="text-3xl lg:text-5xl font-black text-[#1E1E1E] leading-tight tracking-tight">
            Features & Tools
          </h2>
          <div className="mt-3 hidden md:flex items-center justify-center gap-4">
        ...
        <div className="relative w-full max-w-7xl mx-auto flex-grow flex flex-col lg:block">
          {SLIDES.map((slide, index) => (
            <div 
              key={slide.id}
              className={`
                stack-slide 
                w-full bg-[#FFFEFA]
                /* MOBILE: Relative positioning (natural stack), auto height, padding bottom */
                relative h-auto pb-16 px-4
                /* DESKTOP: Absolute positioning (stack on top), full height */
                lg:absolute lg:inset-0 lg:h-full lg:px-0 lg:pb-0
              `}
              style={{ zIndex: 10 + index }}
            >
              <div className="grid lg:grid-cols-12 h-full items-start gap-8 lg:px-12">
                
                {/* Image Side (Desktop Only) */}
                <div className="lg:col-span-3 h-[48vh] hidden lg:block">
                ...
                {/* Content Side */}
                <div className="lg:col-span-9 flex flex-col justify-start pt-1 h-full lg:overflow-visible">
                  {/* MOBILE: Grid cols 1 (1 column) | DESKTOP: Grid cols 2 */}
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-10 gap-y-8 lg:gap-y-8">
                    {slide.items.map((item) => (
                      <div key={item.id} className="space-y-2 lg:space-y-1">
                        <div className="flex items-start gap-3">
                          <CheckCircle2 size={16} className="text-[#1F6ED4] shrink-0 mt-1" />
                          <h3 className="text-[15px] lg:text-[15px] font-black uppercase tracking-tight text-[#1E1E1E] leading-tight">
                            {item.title}
                          </h3>
                        </div>
                        <p className="text-[13px] lg:text-[12px] leading-relaxed text-[#6C757D] font-medium pl-7">
                          {item.text}
                        </p>
                      </div>
                    ))}
              ...
              {/* Divider for Mobile Only to separate sections visually */}
              <div className="block lg:hidden w-full h-px bg-gray-100 mt-10 mx-auto" />
            </div>
          ))}
        </div>

        {/* Footer info (Desktop Only) */}
        <div className="hidden lg:block absolute bottom-0 left-0 w-full z-[110] px-10 text-center pb-6 pt-8 bg-gradient-to-t from-[#FFFEFA] via-[#FFFEFA] to-transparent pointer-events-none">
            <p className="text-[9px] font-black text-[#1F6ED4]/40 uppercase tracking-[0.2em] italic">
               Every feature in chicku.in is designed to scale precisely.
            </p>
        </div>
