...
// import React, { useEffect, useRef } from 'react';
// import { gsap } from 'gsap';
// import { CheckCircle2, TrendingUp, Zap, Bell, ShieldCheck } from 'lucide-react';

// const Hero: React.FC = () => {
//   const containerRef = useRef<HTMLDivElement>(null);
//   const visualRef = useRef<HTMLDivElement>(null);

//   // Background icons (Keep them visible but organized)
//   const bgAssets = [
//     { src: '/logos/facebook.png', x: '10%', y: '15%', size: 'w-10' },
//     { src: '/logos/Linkdin.png', x: '5%', y: '50%', size: 'w-12' },
//     { src: '/logos/youTube.png', x: '15%', y: '85%', size: 'w-14' },
//     { src: '/logos/showcase1.png', x: '75%', y: '85%', size: 'w-24' },
//     { src: '/logos/showCase2.png', x: '90%', y: '20%', size: 'w-32' },
//   ];

//   const integrations = [
//     { id: 'fb', src: '/logos/facebook.png', x: -160, y: -100 },
//     { id: 'ig', src: '/logos/Instagram.png', x: 160, y: -100 },
//     { id: 'wa', src: '/logos/whatSaap.png', x: -180, y: 50 },
//     { id: 'li', src: '/logos/Linkdin.png', x: 180, y: 50 },
//     { id: 'x', src: '/logos/Xlogo.png', x: 0, y: 160 },
//   ];
...
//       // 2. Data Pulse Animation
//       integrations.forEach((_, i) => {
//         gsap.to(`.pulse-line-${i}`, {
//           strokeDashoffset: 0,
//           duration: 2,
//           repeat: -1,
//           ease: "power1.inOut",
...
//       // 3. Magnetic Tilt Animation (The Entire Visual)
//       const handleMouseMove = (e: MouseEvent) => {
//         const { clientX, clientY } = e;
...
//         // Background assets move slightly for parallax depth
//         gsap.to(".bg-parallax", {
...
//   return (
//     <section ref={containerRef} className="relative min-h-screen flex items-center bg-[#FFFEFA] overflow-hidden px-6 lg:px-12 pt-24 lg:pt-0">
      
//       {/* BACKGROUND DESIGN */}
//       <div className="absolute inset-0 z-0 opacity-[0.03] pointer-events-none" 
//         style={{ backgroundImage: `linear-gradient(#1E1E1E 1.5px, transparent 1.5px), linear-gradient(90deg, #1E1E1E 1.5px, transparent 1.5px)`, backgroundSize: '60px 60px' }} 
//       />

//       {/* STYLISH FLOATING LOGOS */}
//       <div className="absolute inset-0 z-0 pointer-events-none">
//         {bgAssets.map((asset, i) => (
//           <div key={i} className="bg-parallax absolute opacity-30" style={{ top: asset.y, left: asset.x }}>
//             <img src={asset.src} alt="" className={`${asset.size} object-contain`} />
//           </div>
//         ))}
//       </div>
...
//           <div className="hero-content inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-[#E9ECEF] shadow-sm mb-8">
//             <span className="w-2 h-2 rounded-full bg-[#28C76F] animate-pulse" />
//             <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#6C757D]">Unified Marketing Suite</span>
//           </div>

//           <h1 className="hero-content text-5xl lg:text-[4.5rem] font-black text-[#1E1E1E] leading-[1.05] mb-8 tracking-tighter">
//             Power Your <br />
//             <span className="text-[#1F6ED4]">Business</span> with <br />
//             <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF8C42] to-[#FFB347]">Smarter Tools</span>
//           </h1>

//           <p className="hero-content text-lg text-[#6C757D] mb-10 max-w-xl leading-relaxed">
//             Manage scheduling, WhatsApp, SMS, and email campaigns in one powerful 
//             dashboard designed for rapid brand growth.
//           </p>

//           <div className="hero-content flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
//             <button className="px-10 py-4 bg-[#1E1E1E] text-white font-bold rounded-2xl hover:bg-[#1F6ED4] transition-all shadow-xl shadow-blue-100">
//               Get Started Free
//             </button>
//             <div className="flex items-center gap-2 text-[#28C76F] font-bold text-sm">
...
//         {/* RIGHT: THE 3D INTERACTIVE CANVAS */}
//         <div className="relative flex justify-center items-center h-[500px] lg:h-[600px]">
          
//           <div ref={visualRef} className="relative w-full h-full flex items-center justify-center" style={{ transformStyle: 'preserve-3d' }}>
            
//             {/* 1. CENTRAL HUB (Modern Glass Dashboard) */}
//             <div className="relative z-30 w-44 h-44 lg:w-56 lg:h-56 bg-white rounded-[3rem] shadow-[0_30px_70px_rgba(0,0,0,0.1)] border border-[#F5F7FA] flex items-center justify-center" style={{ transform: 'translateZ(50px)' }}>
//                <div className="text-center">
//                   <div className="w-16 h-16 bg-[#1F6ED4] rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-blue-200">
//                     <Zap className="text-white fill-white" size={32} />
//                   </div>
//                   <span className="text-[10px] font-black text-[#1E1E1E] uppercase tracking-widest bg-[#F5F7FA] px-3 py-1 rounded-full">Growth Hub</span>
//                </div>
//                {/* Animated Success Badge */}
//                <div className="absolute -top-4 -right-4 w-14 h-14 bg-[#28C76F] rounded-2xl shadow-lg flex items-center justify-center text-white animate-bounce">
//                   <TrendingUp size={28} />
//                </div>
//             </div>

//             {/* 2. PULSING DATA CONNECTORS */}
//             <svg className="absolute inset-0 w-full h-full pointer-events-none z-20" viewBox="0 0 500 500">
//                 {integrations.map((item, i) => (
//                   <path 
//                     key={i}
//                     className={`pulse-line-${i}`}
//                     d={`M 250 250 L ${250 + item.x} ${250 + item.y}`}
...
//                     <stop offset="0%" stopColor="#1F6ED4" />
//                     <stop offset="100%" stopColor="#2CA7DF" />
//                   </linearGradient>
//                 </defs>
//             </svg>

//             {/* 3. INTEGRATION NODES (Floating in 3D) */}
//             {integrations.map((item, i) => (
//               <div 
//                 key={item.id}
//                 className="absolute w-12 h-12 lg:w-16 lg:h-16 bg-white rounded-2xl shadow-xl border border-[#F5F7FA] flex items-center justify-center p-3 transition-transform hover:scale-110"
//                 style={{ 
//                   transform: `translate(${item.x}px, ${item.y}px) translateZ(30px)`
//                 }}
//               >
...
//             {/* 4. FLOATING STATUS TOASTS (Professional Feature Reveal) */}
//             <div className="absolute top-0 left-0 bg-white/80 backdrop-blur-md p-3 rounded-2xl shadow-lg border border-[#E9ECEF] flex items-center gap-3" style={{ transform: 'translate(-120px, -200px) translateZ(80px)' }}>
//                <div className="w-8 h-8 rounded-full bg-[#8E44AD] flex items-center justify-center text-white"><Bell size={14} /></div>
//                <span className="text-[10px] font-bold text-[#1E1E1E]">Post Scheduled to Instagram</span>
//             </div>

//             <div className="absolute bottom-0 right-0 bg-white/80 backdrop-blur-md p-3 rounded-2xl shadow-lg border border-[#E9ECEF] flex items-center gap-3" style={{ transform: 'translate(100px, 180px) translateZ(60px)' }}>
//                <div className="w-8 h-8 rounded-full bg-[#28C76F] flex items-center justify-center text-white"><ShieldCheck size={14} /></div>
//                <span className="text-[10px] font-bold text-[#1E1E1E]">WhatsApp Privacy Verified</span>
//             </div>
