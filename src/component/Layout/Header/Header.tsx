    ...
    <header className="fixed top-0 left-0 right-0 h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 z-50">
      ...
      <div className="flex items-center gap-4">
        ...
        <Link to="/" className="flex items-center gap-2">
            <img src="https://www.shutterstock.com/shutterstock/photos/2451554031/display_1500/stock-vector-creative-people-connect-logo-minimal-together-unity-logo-diversity-partnership-logo-icon-symbol-2451554031.jpg" alt="Company Logo" className="h-10 w-auto" />
