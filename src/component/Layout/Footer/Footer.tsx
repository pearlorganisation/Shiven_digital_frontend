      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-5 lg:col-span-4">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Leading provider of innovative solutions for modern businesses. Committed to excellence and technological advancement.
            </p>
          </div>
          ...
          <div className="md:col-span-12 lg:col-span-3">
            ...
            <ul className="space-y-3">
              <li><a href="/privacy" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">Privacy Policy</a></li>
              <li><a href="/terms" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">Terms of Service</a></li>
        ...
        <div className="py-6 border-t border-gray-200">
          <p className="text-center text-sm text-gray-500">
            © {new Date().getFullYear()} Shiven Digital. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
